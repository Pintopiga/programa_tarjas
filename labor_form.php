...
?>
  ...
  <h2><?= $edit ? 'Editar' : 'Agregar' ?> Labor</h2>
  <form method="POST" action="labor_save.php">
    ...
    <div class="mb-3 col-md-1">
      <label for="labor_id" class="form-label">ID Labor</label>
    ...
    <div class="mb-3 col-md-3">
      <label for="descripcion_labor" class="form-label">Descripción</label>
